...
function Badjokes() {
  const[Badjokes, setjokes]=useState()
    //  start of jokes 
    function badjokes() {
      var options = {
        method: 'GET',
      ...
      //working on this to call 
      axios.request(options).then(function (badjokes) {
        console.log(badjokes.data);
        setjokes(badjokes.data.body.setup.punchline)
